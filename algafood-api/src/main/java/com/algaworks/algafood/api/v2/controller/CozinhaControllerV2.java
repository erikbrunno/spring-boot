...
@RestController
@RequestMapping(path = "/v2/cozinhas", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
public class CozinhaControllerV2 implements CozinhaControllerOpenApiV2 {
	...
	@GetMapping
	public PagedModel<CozinhaModelV2> pesquisar(@PageableDefault(size = 10) Pageable pageable) {

...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp),
...
insert into usuario (id, nome, email, senha, data_cadastro) values
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp),
(6, 'Erik Brunno', 'erik.brunno@yahoo.com.br', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp),
(7, 'Débora mendonça', 'erik.brunno@gmail.com', '$2a$12$UgZkIytsr3L6LuLhuzzXDOBq6jsV4WesBynJ/sO4V/z9UlVu9IJhK', utc_timestamp);  ;
...
values (1, '2ed9feb0-d948-4e47-869c-bfde76a041a8', 1, 6, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'ad31e819-dfee-40bd-a768-4e11b86299fb',  4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',

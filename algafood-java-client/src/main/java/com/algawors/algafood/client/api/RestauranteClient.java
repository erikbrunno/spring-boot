...
public class RestauranteClient {
	...
	private static final String RESOURCE_PATH = "/restaurantes?projecao=resumo";
	private static final String RESOURCE_PATH_RESTAURANTE = "/restaurantes";
	...
	public RestauranteModel adicionar(RestauranteInput restaurante) {
		  var resourceUri = URI.create(url + RESOURCE_PATH_RESTAURANTE);
